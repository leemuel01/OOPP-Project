...
from Flask.Models import Blood_Transfusions, Allergies, Surgeries, Admissions, Personal_Profile, Vaccinations
from Flask.medical_history.forms import Blood_Transfusion_History_Form, Allergy_History_Form, Previous_Surgeries_Form, \
    Previous_Admissions_Form, Personal_Profile_Form, Vaccine_History_Form
